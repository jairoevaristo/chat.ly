...
export function GalleryImage({ photo, onClick, isVisible }: GalleryImageProps) {
  ...
  return (
    <div className={`fixed bg-outside w-screen h-screen flex justify-center items-center z-30 ${!isVisible && 'hidden'}`}>
      ...
      <div className="xl:w-[55vw] flex items-center justify-center px-6 lg:px-0">
        <img src={photoComponent} alt="foto do avatar" className="rounded-sm md:h-[70vh] xl:h-[90vh]" />
      </div>
    </div>
  )
}